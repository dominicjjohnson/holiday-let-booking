...
<div class="hlb-booking-form-wrapper">
    ...
    <aside class="hlb-booking-info">
        ...
        <ul>
            ...
            <li><strong><?php _e( 'Deposit:', 'holiday-let-booking' ); ?></strong> <?php _e( '25% due on booking', 'holiday-let-booking' ); ?></li>
            <li><strong><?php _e( 'Cancellation:', 'holiday-let-booking' ); ?></strong> <?php _e( 'Full refund up to 14 days before arrival', 'holiday-let-booking' ); ?></li>
